        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              Textutils gives you a way to analyse your text quickly and efficiently. Be it word count or character
              count.
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              Opera. It suits to count characters in facebook, bing, excel document, pdf document, essays, etc.
            </div>
          </div>
        </div>
      </div>
